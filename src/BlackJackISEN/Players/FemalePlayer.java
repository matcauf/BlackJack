...
/**
 * defini la maniere dont une joueuse demandera des cartes gerera son tapis elle
 * peut offrir des verres, parler etre agresser.
 * 
 * @author matthieu
 * 
 */
public class FemalePlayer extends Player implements MoneyPlayers, IvrePlayer,
		Replique {
	/**
	 * Tapis du joueur
	 */
	...
	/**
	 * Constructeur de joueuse initialisant son tapis et aussi le nom cf player
	 * 
	 * @param name
	 *            nom du joueur
	 * @param stack
	 ...
	 */
	public FemalePlayer(String name, int stack) throws SaisieErroneeException {
		super(name);
		genderStrategie = 15;
	...
	public void betturn(int miseMini) {
		tapis.setMise((int) (Math.random()
				* (tapis.getStack() * 0.05 - miseMini) + miseMini));
	}
